...
function mikiurl_menu()
{
	if( $_GET['action'] == 'kaydet'):
		mikiurl_kaydet();
		echo '<div class="updated fade" id="message"><p><strong>Setting Saved/Ayarlarınız Kaydedildi</strong></p></div>';
	endif;
	...
	<div style="width: 800px; margin-bottom: 20px; height: auto;"><h2 style="color:#2583AD;">Settings/Ayarlar</h2>
	<div id="options">
	...
	<td><input type="password" value="'.stripslashes($mikiurl_ayarlar['twitter_sifre']).'" size="40" id="twitter_password" name="twitter_sifre"/></td>
		...
		<tr valign="top">
	<th scope="row">prefix your message/mesaj ön eki <br/><small>(example: My new blog post: )</small></th>
	<td><input type="text" value="'.stripslashes($mikiurl_ayarlar['onek']).'" size="40" id="onek" name="onek"/></td>
	</tr>
	</tbody>
	</table>
	
	<p class="submit"><input type="submit" value="Save/Ayarları Kaydet" name="btnSave"/></p></form></div></div></div>';
}
?>